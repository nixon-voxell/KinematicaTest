...
namespace BipedLocomotion
{
    ...
    {
        public float SynthesizeDelta = 0.1f;
        public float SynthesizeDeltaCounter = 0.0f;
        ...
        void Update()
        {
            ...
            this.SynthesizeDeltaCounter += Time.deltaTime;

            if (this.SynthesizeDeltaCounter >= this.SynthesizeDelta)
            {
                ...
                this.SynthesizeDeltaCounter = 0.0f;
            }
        }
